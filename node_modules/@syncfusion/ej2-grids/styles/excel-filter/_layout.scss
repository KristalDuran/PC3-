@include export-module('excel-filter-layout') {
  ...
  .sf-grid .e-excelfilter {
    ...
    .e-contextmenu-wrapper.e-sfcontextmenu .e-ul .e-menu-item:not(.e-separator) {
      height: 26px;
      line-height: 26px;
    }

    .e-contextmenu-wrapper.e-sfcontextmenu .e-ul .e-separator {
      height: auto;
    }

    .e-contextmenu-wrapper.e-sfcontextmenu .e-ul {
      position: absolute;
    }
